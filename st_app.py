...
def grafico_estudantes(IES, CURSO, GRAFICOS, dados1):
  ...
  if(len(GRAFICOS) == 0):
    ...
    if('Formas de Ingresso' in GRAFICOS):

      y_masculino4 = []
      y_feminino4 = []

      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1)]['TP_SEXO'].count())
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2)]['TP_SEXO'].count())
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_INGRESSO_VESTIBULAR'] == 1)]['TP_SEXO'].count() - (dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_INGRESSO_VESTIBULAR'] == 1) & (dados1['IN_RESERVA_VAGAS'] == 1)]['TP_SEXO'].count()))
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_INGRESSO_VESTIBULAR'] == 1)]['TP_SEXO'].count() - (dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_INGRESSO_VESTIBULAR'] == 1) & (dados1['IN_RESERVA_VAGAS'] == 1)]['TP_SEXO'].count()))
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_INGRESSO_ENEM'] == 1)]['TP_SEXO'].count() - (dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_INGRESSO_ENEM'] == 1) & (dados1['IN_RESERVA_VAGAS'] == 1)]['TP_SEXO'].count()))
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_INGRESSO_ENEM'] == 1)]['TP_SEXO'].count() - (dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_INGRESSO_ENEM'] == 1) & (dados1['IN_RESERVA_VAGAS'] == 1)]['TP_SEXO'].count()))
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_INGRESSO_VAGA_REMANESC'] == 1)]['TP_SEXO'].count() - (dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_INGRESSO_VAGA_REMANESC'] == 1) & (dados1['IN_RESERVA_VAGAS'] == 1)]['TP_SEXO'].count()))
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_INGRESSO_VAGA_REMANESC'] == 1)]['TP_SEXO'].count() - (dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_INGRESSO_VAGA_REMANESC'] == 1) & (dados1['IN_RESERVA_VAGAS'] == 1)]['TP_SEXO'].count()))
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_RESERVA_ENSINO_PUBLICO'] == 1)]['TP_SEXO'].count())
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_RESERVA_ENSINO_PUBLICO'] == 1)]['TP_SEXO'].count())
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_RESERVA_ETNICO'] == 1)]['TP_SEXO'].count())
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_RESERVA_ETNICO'] == 1)]['TP_SEXO'].count())
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_RESERVA_RENDA_FAMILIAR'] == 1)]['TP_SEXO'].count())
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_RESERVA_RENDA_FAMILIAR'] == 1)]['TP_SEXO'].count())
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1) & (dados1['IN_RESERVA_DEFICIENCIA'] == 1)]['TP_SEXO'].count())
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2) & (dados1['IN_RESERVA_DEFICIENCIA'] == 1)]['TP_SEXO'].count())
      y_feminino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 1)]['TP_SEXO'].count() - y_feminino4[1] - y_feminino4[2] - y_feminino4[3] - y_feminino4[4] - y_feminino4[5] - y_feminino4[6] - y_feminino4[7])
      y_masculino4.append(dados1[(dados1['SG_IES'] == IES) & (dados1['NO_CURSO'] == CURSO) & (dados1['TP_SEXO'] == 2)]['TP_SEXO'].count() - y_masculino4[1] - y_masculino4[2] - y_masculino4[3] - y_masculino4[4] - y_masculino4[5] - y_masculino4[6] - y_masculino4[7])

      maiorcount = 0
      if(max(y_masculino4) > maiorcount):
        maiorcount = max(y_masculino4)
        if(max(y_feminino4) > max(y_masculino4)):
          maiorcount = max(y_feminino4)

      formas_de_ingresso = ['Total', 'Ingresso (Vestibular)', 'Ingresso (Enem)', 'Ingresso (Vagas Remanescentes)', 'Reserva de Vagas (Ensino Público)', 'Reserva de Vagas (Vagas Étnicas)', 'Reserva de Vagas (Renda Familiar)', 'Reserva de Vagas (Deficiência)', 'Outras Formas']

      fig4 = go.Figure(data=[go.Bar(name = 'Homens', x = y_masculino4, y = formas_de_ingresso, text = y_masculino4, marker_pattern_shape="/", orientation='h'), go.Bar(name = 'Mulheres', x = y_feminino4, y= formas_de_ingresso, text = y_feminino4, marker_pattern_shape="x", marker_color='#f63366', orientation='h')])

      fig4.update_xaxes(range = [0, maiorcount+50], tickfont_size=11, showgrid = False)
      fig4.update_yaxes(tickfont_size=11)
      fig4.update_traces(textposition = 'outside', textfont_size=11)
      fig4.update_layout(title_text = f'Quantidade de Estudantes entre Homens e Mulheres por Formas de Ingresso<br>no Curso de {CURSO} da {IES} no Ano de 2019', barmode='group', legend=dict(yanchor = 'top', y = 1, xanchor = 'right', x = 1))
...
def estudantes(titulo, espaco1, descricao1, descricao2, dados1):
  ...
  escolha_GRAFICOS = st.sidebar.multiselect('Escolha uma ou mais opções para analisar:', ['Cor/Raça', 'Formas de Ingresso', 'Idades', 'Situações'], default = ['Cor/Raça'])
...
def load_data_alunos():
  ...
  dados14_alunos = pd.read_csv('SUP_ALUNO14.CSV', sep='|', encoding='utf8')
  dados15_alunos = pd.read_csv('SUP_ALUNO15.CSV', sep='|', encoding='utf8')
  dados16_alunos = pd.read_csv('SUP_ALUNO16.CSV', sep='|', encoding='utf8')
  dados17_alunos = pd.read_csv('SUP_ALUNO17.CSV', sep='|', encoding='utf8')
  dados18_alunos = pd.read_csv('SUP_ALUNO18.CSV', sep='|', encoding='utf8')
  dados19_alunos = pd.read_csv('SUP_ALUNO19.CSV', sep='|', encoding='utf8')
  dados20_alunos = pd.read_csv('SUP_ALUNO20.CSV', sep='|', encoding='utf8')
  dados21_alunos = pd.read_csv('SUP_ALUNO21.CSV', sep='|', encoding='utf8')
  dados22_alunos = pd.read_csv('SUP_ALUNO22.CSV', sep='|', encoding='utf8')
  ...
  dados_ALUNOS = pd.concat([dados1_alunos, dados2_alunos, dados3_alunos, dados4_alunos, dados5_alunos, dados6_alunos, dados7_alunos, dados8_alunos, dados9_alunos, dados10_alunos, dados11_alunos, dados12_alunos, dados13_alunos, dados14_alunos, dados15_alunos, dados16_alunos, dados17_alunos, dados18_alunos, dados19_alunos, dados20_alunos, dados21_alunos, dados22_alunos, dados23_alunos, dados24_alunos, dados25_alunos])
